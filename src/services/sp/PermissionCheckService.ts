...
export class PermissionCheckService{
    ...
    public async checkUserPermissions(userEmail: string){
        var url = `${this.siteUrl}/_api/web/getUserEffectivePermissions('${encodeURIComponent("i:0#.f|membership|" + userEmail)}')`
